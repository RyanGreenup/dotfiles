...
wk.add({
  {
    ...
    { "<leader>nif", require('utils/citations').fetch_and_insert,                 desc = "Fetch Citation from URL" },
    { "<leader>nii", require('utils/citations').pick_citation,                    desc = "Insert Existing Citation" },
    { "<leader>niv", require('utils/citations').fetch_from_clipboard,             desc = "Fetch Citation from Clipboard" },
