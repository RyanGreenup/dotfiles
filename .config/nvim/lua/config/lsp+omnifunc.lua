...
------------------------------------------------------------
-- Bind to Omnifunc <C-x><C-o>
------------------------------------------------------------

-- By default lsp doesn't bind to omnifunc and relies on an autocomplete
-- plugin like nvim-cmp.
-- This makes omnifunc lsp aware so the autocomplete is not a gamebreaker
