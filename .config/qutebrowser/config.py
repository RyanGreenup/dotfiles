...
c.url.searchengines = {
        ...
        # 'mw': 'http://localhost:8076/mediawiki/index.php?search={}&title=Special%3ASearch&go=Go',
        'mw': 'http://vale:8076/mediawiki/index.php?search={}&title=Special%3ASearch&go=Go',
